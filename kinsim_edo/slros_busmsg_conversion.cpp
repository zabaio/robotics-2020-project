...
// Conversions between SL_Bus_kinsim_edo_ros_time_Duration and ros::Duration

void convertFromBus(ros::Duration* msgPtr, SL_Bus_kinsim_edo_ros_time_Duration const* busPtr)
{
...
void convertToBus(SL_Bus_kinsim_edo_ros_time_Duration* busPtr, ros::Duration const* msgPtr)
{
  const std::string rosMessageType("ros_time/Duration");
...
// Conversions between SL_Bus_kinsim_edo_ros_time_Time and ros::Time

void convertFromBus(ros::Time* msgPtr, SL_Bus_kinsim_edo_ros_time_Time const* busPtr)
{
...
void convertToBus(SL_Bus_kinsim_edo_ros_time_Time* busPtr, ros::Time const* msgPtr)
{
  const std::string rosMessageType("ros_time/Time");
...
// Conversions between SL_Bus_kinsim_edo_rosgraph_msgs_Clock and rosgraph_msgs::Clock

void convertFromBus(rosgraph_msgs::Clock* msgPtr, SL_Bus_kinsim_edo_rosgraph_msgs_Clock const* busPtr)
{
...
void convertToBus(SL_Bus_kinsim_edo_rosgraph_msgs_Clock* busPtr, rosgraph_msgs::Clock const* msgPtr)
{
  const std::string rosMessageType("rosgraph_msgs/Clock");
...
// Conversions between SL_Bus_kinsim_edo_sensor_msgs_JointState and sensor_msgs::JointState

void convertFromBus(sensor_msgs::JointState* msgPtr, SL_Bus_kinsim_edo_sensor_msgs_JointState const* busPtr)
{
...
void convertToBus(SL_Bus_kinsim_edo_sensor_msgs_JointState* busPtr, sensor_msgs::JointState const* msgPtr)
{
  const std::string rosMessageType("sensor_msgs/JointState");
...
// Conversions between SL_Bus_kinsim_edo_std_msgs_Header and std_msgs::Header

void convertFromBus(std_msgs::Header* msgPtr, SL_Bus_kinsim_edo_std_msgs_Header const* busPtr)
{
...
void convertToBus(SL_Bus_kinsim_edo_std_msgs_Header* busPtr, std_msgs::Header const* msgPtr)
{
  const std::string rosMessageType("std_msgs/Header");
...
// Conversions between SL_Bus_kinsim_edo_trajectory_msgs_JointTrajectoryPoint and trajectory_msgs::JointTrajectoryPoint

void convertFromBus(trajectory_msgs::JointTrajectoryPoint* msgPtr, SL_Bus_kinsim_edo_trajectory_msgs_JointTrajectoryPoint const* busPtr)
{
...
void convertToBus(SL_Bus_kinsim_edo_trajectory_msgs_JointTrajectoryPoint* busPtr, trajectory_msgs::JointTrajectoryPoint const* msgPtr)
{
  const std::string rosMessageType("trajectory_msgs/JointTrajectoryPoint");
