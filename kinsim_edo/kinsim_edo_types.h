...
//
#ifndef RTW_HEADER_kinsim_edo_types_h_
#define RTW_HEADER_kinsim_edo_types_h_
#include "rtwtypes.h"
...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_kinsim_edo_std_msgs_String_
#define DEFINED_TYPEDEF_FOR_SL_Bus_kinsim_edo_std_msgs_String_
...
} SL_Bus_kinsim_edo_std_msgs_String;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_kinsim_edo_ros_time_Time_
#define DEFINED_TYPEDEF_FOR_SL_Bus_kinsim_edo_ros_time_Time_

// MsgType=ros_time/Time
typedef struct {
  real_T Sec;
  real_T Nsec;
} SL_Bus_kinsim_edo_ros_time_Time;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_kinsim_edo_std_msgs_Header_
#define DEFINED_TYPEDEF_FOR_SL_Bus_kinsim_edo_std_msgs_Header_
...
typedef struct {
  ...
  // MsgType=ros_time/Time
  SL_Bus_kinsim_edo_ros_time_Time Stamp;
} SL_Bus_kinsim_edo_std_msgs_Header;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_kinsim_edo_sensor_msgs_JointState_
#define DEFINED_TYPEDEF_FOR_SL_Bus_kinsim_edo_sensor_msgs_JointState_
...
typedef struct {
  ...
  SL_Bus_kinsim_edo_std_msgs_String Name[16];
  ...
  // MsgType=std_msgs/Header
  SL_Bus_kinsim_edo_std_msgs_Header Header;
} SL_Bus_kinsim_edo_sensor_msgs_JointState;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_kinsim_edo_rosgraph_msgs_Clock_
#define DEFINED_TYPEDEF_FOR_SL_Bus_kinsim_edo_rosgraph_msgs_Clock_

// MsgType=rosgraph_msgs/Clock
typedef struct {
  // MsgType=ros_time/Time
  SL_Bus_kinsim_edo_ros_time_Time Clock_;
} SL_Bus_kinsim_edo_rosgraph_msgs_Clock;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_kinsim_edo_ros_time_Duration_
#define DEFINED_TYPEDEF_FOR_SL_Bus_kinsim_edo_ros_time_Duration_

// MsgType=ros_time/Duration
typedef struct {
  real_T Sec;
  real_T Nsec;
} SL_Bus_kinsim_edo_ros_time_Duration;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_kinsim_edo_trajectory_msgs_JointTrajectoryPoint_
#define DEFINED_TYPEDEF_FOR_SL_Bus_kinsim_edo_trajectory_msgs_JointTrajectoryPoint_
...
typedef struct {
  ...
  // MsgType=ros_time/Duration
  SL_Bus_kinsim_edo_ros_time_Duration TimeFromStart;
} SL_Bus_kinsim_edo_trajectory_msgs_JointTrajectoryPoint;
...
#ifndef typedef_emxArray_char_T_kinsim_edo_T
#define typedef_emxArray_char_T_kinsim_edo_T

typedef struct emxArray_char_T emxArray_char_T_kinsim_edo_T;

#endif                                 //typedef_emxArray_char_T_kinsim_edo_T
...
#ifndef typedef_emxArray_real_T_kinsim_edo_T
#define typedef_emxArray_real_T_kinsim_edo_T

typedef struct emxArray_real_T emxArray_real_T_kinsim_edo_T;

#endif                                 //typedef_emxArray_real_T_kinsim_edo_T

// Custom Type definition for MATLAB Function: '<Root>/Assign to CartesianState msg' 
#ifndef struct_tag_LiZKcCZodb3W5JjO2srbqH
#define struct_tag_LiZKcCZodb3W5JjO2srbqH

struct tag_LiZKcCZodb3W5JjO2srbqH
{
  char_T f1[6];
};

#endif                                 //struct_tag_LiZKcCZodb3W5JjO2srbqH

#ifndef typedef_cell_wrap_0_kinsim_edo_T
#define typedef_cell_wrap_0_kinsim_edo_T

typedef struct tag_LiZKcCZodb3W5JjO2srbqH cell_wrap_0_kinsim_edo_T;

#endif                                 //typedef_cell_wrap_0_kinsim_edo_T
...
#ifndef typedef_cell_wrap_0_kinsim_edo_a_T
#define typedef_cell_wrap_0_kinsim_edo_a_T

typedef struct tag_rGJxeAeFOtyQ9icBnCewuB cell_wrap_0_kinsim_edo_a_T;

#endif                                 //typedef_cell_wrap_0_kinsim_edo_a_T
...
#ifndef typedef_f_cell_wrap_kinsim_edo_T
#define typedef_f_cell_wrap_kinsim_edo_T

typedef struct tag_8EP4ctv7s0SDnh3V6WCLOG f_cell_wrap_kinsim_edo_T;

#endif                                 //typedef_f_cell_wrap_kinsim_edo_T
...
{
  emxArray_char_T_kinsim_edo_T *Type;
  real_T PositionNumber;
  emxArray_real_T_kinsim_edo_T *MotionSubspace;
  real_T JointToParentTransform[16];
  real_T ChildToJointTransform[16];
...
#ifndef typedef_c_rigidBodyJoint_kinsim_edo_T
#define typedef_c_rigidBodyJoint_kinsim_edo_T

typedef struct tag_rHHvNgfpb6xtLaCol8pZFD c_rigidBodyJoint_kinsim_edo_T;

#endif                                 //typedef_c_rigidBodyJoint_kinsim_edo_T
...
struct tag_4d0yO3DNkhaNLE6JP8DrI
{
  ...
  c_rigidBodyJoint_kinsim_edo_T JointInternal;
  real_T ParentIndex;
};
...
{
  emxArray_char_T_kinsim_edo_T *NameInternal;
  c_rigidBodyJoint_kinsim_edo_T JointInternal;
};
...
#ifndef typedef_c_rigidBodyJoint_kinsim_edo_p_T
#define typedef_c_rigidBodyJoint_kinsim_edo_p_T

typedef struct tag_2xAJzS7rvIyFzfuC7FOGlD c_rigidBodyJoint_kinsim_edo_p_T;

#endif                                 //typedef_c_rigidBodyJoint_kinsim_edo_p_T
...
{
  char_T NameInternal[6];
  c_rigidBodyJoint_kinsim_edo_p_T JointInternal;
  real_T ParentIndex;
};

#endif                                 //struct_tag_AV1LBgFrotghMr9djKBRN

#ifndef typedef_l_robotics_manip_internal_R_p_T
#define typedef_l_robotics_manip_internal_R_p_T

typedef struct tag_AV1LBgFrotghMr9djKBRN l_robotics_manip_internal_R_p_T;

#endif                                 //typedef_l_robotics_manip_internal_R_p_T
...
#ifndef typedef_m_robotics_manip_internal_R_p_T
#define typedef_m_robotics_manip_internal_R_p_T

typedef struct tag_EpnOXkcFkOFmcaZiu2CuCD m_robotics_manip_internal_R_p_T;

#endif                                 //typedef_m_robotics_manip_internal_R_p_T
...
{
  real_T NumBodies;
  m_robotics_manip_internal_R_p_T Base;
  l_robotics_manip_internal_R_p_T *Bodies[6];
  real_T PositionNumber;
};

#endif                                 //struct_tag_vjc6KIMqa87986f8hhDLFH

#ifndef typedef_n_robotics_manip_internal_R_p_T
#define typedef_n_robotics_manip_internal_R_p_T

typedef struct tag_vjc6KIMqa87986f8hhDLFH n_robotics_manip_internal_R_p_T;

#endif                                 //typedef_n_robotics_manip_internal_R_p_T
...
{
  int32_T isInitialized;
  n_robotics_manip_internal_R_p_T TreeInternal;
};

#endif                                 //struct_tag_cGBQnFP5Mh4Emo8puqX8QF

#ifndef typedef_robotics_slmanip_internal_b_p_T
#define typedef_robotics_slmanip_internal_b_p_T

typedef struct tag_cGBQnFP5Mh4Emo8puqX8QF robotics_slmanip_internal_b_p_T;

#endif                                 //typedef_robotics_slmanip_internal_b_p_T
...
#ifndef typedef_emxArray_f_cell_wrap_kinsim_e_T
#define typedef_emxArray_f_cell_wrap_kinsim_e_T

typedef struct emxArray_tag_8EP4ctv7s0SDnh3V6W emxArray_f_cell_wrap_kinsim_e_T;

#endif                                 //typedef_emxArray_f_cell_wrap_kinsim_e_T

// Parameters (default storage)
typedef struct P_kinsim_edo_T_ P_kinsim_edo_T;

// Forward declaration for rtModel
typedef struct tag_RTM_kinsim_edo_T RT_MODEL_kinsim_edo_T;

#endif                                 // RTW_HEADER_kinsim_edo_types_h_
