...
//
// File: dynsim_edo_drag_gravity_types.h
//
...
//
#ifndef RTW_HEADER_dynsim_edo_drag_gravity_types_h_
#define RTW_HEADER_dynsim_edo_drag_gravity_types_h_
#include "rtwtypes.h"
...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_edo_drag_gravity_std_msgs_String_
#define DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_edo_drag_gravity_std_msgs_String_
...
} SL_Bus_dynsim_edo_drag_gravity_std_msgs_String;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_edo_drag_gravity_ros_time_Time_
#define DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_edo_drag_gravity_ros_time_Time_

// MsgType=ros_time/Time
typedef struct {
  real_T Sec;
  real_T Nsec;
} SL_Bus_dynsim_edo_drag_gravity_ros_time_Time;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_edo_drag_gravity_std_msgs_Header_
#define DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_edo_drag_gravity_std_msgs_Header_
...
typedef struct {
  ...
  // MsgType=ros_time/Time
  SL_Bus_dynsim_edo_drag_gravity_ros_time_Time Stamp;
} SL_Bus_dynsim_edo_drag_gravity_std_msgs_Header;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_edo_drag_gravity_sensor_msgs_JointState_
#define DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_edo_drag_gravity_sensor_msgs_JointState_
...
typedef struct {
  ...
  SL_Bus_dynsim_edo_drag_gravity_std_msgs_String Name[16];
  ...
  // MsgType=std_msgs/Header
  SL_Bus_dynsim_edo_drag_gravity_std_msgs_Header Header;
} SL_Bus_dynsim_edo_drag_gravity_sensor_msgs_JointState;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_edo_drag_gravity_rosgraph_msgs_Clock_
#define DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_edo_drag_gravity_rosgraph_msgs_Clock_

// MsgType=rosgraph_msgs/Clock
typedef struct {
  // MsgType=ros_time/Time
  SL_Bus_dynsim_edo_drag_gravity_ros_time_Time Clock_;
} SL_Bus_dynsim_edo_drag_gravity_rosgraph_msgs_Clock;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_edo_drag_gravity_std_msgs_MultiArrayDimension_
#define DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_edo_drag_gravity_std_msgs_MultiArrayDimension_
...
#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_edo_drag_gravity_std_msgs_MultiArrayLayout_
#define DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_edo_drag_gravity_std_msgs_MultiArrayLayout_
...
typedef struct {
  ...
  SL_Bus_dynsim_edo_drag_gravity_std_msgs_MultiArrayDimension Dim[16];

  // IsVarLen=1:VarLenCategory=length:VarLenElem=Dim
  SL_Bus_ROSVariableLengthArrayInfo Dim_SL_Info;
} SL_Bus_dynsim_edo_drag_gravity_std_msgs_MultiArrayLayout;

#endif

#ifndef DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_edo_drag_gravity_std_msgs_Float64MultiArray_
#define DEFINED_TYPEDEF_FOR_SL_Bus_dynsim_edo_drag_gravity_std_msgs_Float64MultiArray_
...
typedef struct {
  ...
  // MsgType=std_msgs/MultiArrayLayout
  SL_Bus_dynsim_edo_drag_gravity_std_msgs_MultiArrayLayout Layout;
} SL_Bus_dynsim_edo_drag_gravity_std_msgs_Float64MultiArray;
...
#ifndef typedef_emxArray_char_T_dynsim_edo_dr_T
#define typedef_emxArray_char_T_dynsim_edo_dr_T

typedef struct emxArray_char_T emxArray_char_T_dynsim_edo_dr_T;

#endif                                 //typedef_emxArray_char_T_dynsim_edo_dr_T
...
#ifndef typedef_emxArray_real_T_dynsim_edo_dr_T
#define typedef_emxArray_real_T_dynsim_edo_dr_T

typedef struct emxArray_real_T emxArray_real_T_dynsim_edo_dr_T;

#endif                                 //typedef_emxArray_real_T_dynsim_edo_dr_T
...
#ifndef typedef_cell_wrap_0_dynsim_edo_drag_g_T
#define typedef_cell_wrap_0_dynsim_edo_drag_g_T

typedef struct tag_rGJxeAeFOtyQ9icBnCewuB cell_wrap_0_dynsim_edo_drag_g_T;

#endif                                 //typedef_cell_wrap_0_dynsim_edo_drag_g_T
...
#ifndef typedef_f_cell_wrap_dynsim_edo_drag_g_T
#define typedef_f_cell_wrap_dynsim_edo_drag_g_T

typedef struct tag_8EP4ctv7s0SDnh3V6WCLOG f_cell_wrap_dynsim_edo_drag_g_T;

#endif                                 //typedef_f_cell_wrap_dynsim_edo_drag_g_T
...
{
  emxArray_char_T_dynsim_edo_dr_T *Type;
  real_T PositionNumber;
  emxArray_real_T_dynsim_edo_dr_T *MotionSubspace;
  real_T JointToParentTransform[16];
  real_T ChildToJointTransform[16];
...
#ifndef typedef_c_rigidBodyJoint_dynsim_edo_d_T
#define typedef_c_rigidBodyJoint_dynsim_edo_d_T

typedef struct tag_rHHvNgfpb6xtLaCol8pZFD c_rigidBodyJoint_dynsim_edo_d_T;

#endif                                 //typedef_c_rigidBodyJoint_dynsim_edo_d_T
...
struct tag_4d0yO3DNkhaNLE6JP8DrI
{
  ...
  c_rigidBodyJoint_dynsim_edo_d_T JointInternal;
  real_T ParentIndex;
};
...
{
  emxArray_char_T_dynsim_edo_dr_T *NameInternal;
  c_rigidBodyJoint_dynsim_edo_d_T JointInternal;
};
...
#ifndef typedef_c_rigidBodyJoint_dynsim_edo_l_T
#define typedef_c_rigidBodyJoint_dynsim_edo_l_T

typedef struct tag_2xAJzS7rvIyFzfuC7FOGlD c_rigidBodyJoint_dynsim_edo_l_T;

#endif                                 //typedef_c_rigidBodyJoint_dynsim_edo_l_T
...
{
  char_T NameInternal[6];
  c_rigidBodyJoint_dynsim_edo_l_T JointInternal;
  real_T ParentIndex;
};
...
#ifndef typedef_f_cell_wrap_dynsim_edo_drag_l_T
#define typedef_f_cell_wrap_dynsim_edo_drag_l_T

typedef struct tag_pGgszObO16I6TGXaEMnuXB f_cell_wrap_dynsim_edo_drag_l_T;

#endif                                 //typedef_f_cell_wrap_dynsim_edo_drag_l_T
...
#ifndef typedef_c_rigidBodyJoint_dynsim_ed_ld_T
#define typedef_c_rigidBodyJoint_dynsim_ed_ld_T

typedef struct tag_QsLFVUgAtzQUBY1V99co0D c_rigidBodyJoint_dynsim_ed_ld_T;

#endif                                 //typedef_c_rigidBodyJoint_dynsim_ed_ld_T
...
{
  real_T Index;
  c_rigidBodyJoint_dynsim_ed_ld_T JointInternal;
  real_T ParentIndex;
  real_T SpatialInertia[36];
};
...
#ifndef typedef_l_robotics_manip_internal__ld_T
#define typedef_l_robotics_manip_internal__ld_T

typedef struct tag_IYTryndM9hCl2aQvRVOEpC l_robotics_manip_internal__ld_T;

#endif                                 //typedef_l_robotics_manip_internal__ld_T
...
#ifndef typedef_m_robotics_manip_internal__ld_T
#define typedef_m_robotics_manip_internal__ld_T

typedef struct tag_Y04n94zUMq8rhLX3OxwtfD m_robotics_manip_internal__ld_T;

#endif                                 //typedef_m_robotics_manip_internal__ld_T
...
{
  real_T NumBodies;
  m_robotics_manip_internal__ld_T Base;
  real_T Gravity[3];
  l_robotics_manip_internal__ld_T *Bodies[6];
  real_T VelocityNumber;
  real_T PositionDoFMap[12];
  real_T VelocityDoFMap[12];
};
...
#ifndef typedef_n_robotics_manip_internal__ld_T
#define typedef_n_robotics_manip_internal__ld_T

typedef struct tag_mYgZv8X39cdHbKQNQhG0oD n_robotics_manip_internal__ld_T;

#endif                                 //typedef_n_robotics_manip_internal__ld_T
...
{
  int32_T isInitialized;
  n_robotics_manip_internal__ld_T TreeInternal;
};

#endif                                 //struct_tag_uU4fM87gRHLNKfBsLIBxeE

#ifndef typedef_robotics_slmanip_internal__ld_T
#define typedef_robotics_slmanip_internal__ld_T

typedef struct tag_uU4fM87gRHLNKfBsLIBxeE robotics_slmanip_internal__ld_T;

#endif                                 //typedef_robotics_slmanip_internal__ld_T
...
{
  f_cell_wrap_dynsim_edo_drag_g_T *data;
  int32_T *size;
  int32_T allocatedSize;
  int32_T numDimensions;
  boolean_T canFreeData;
...
{
  f_cell_wrap_dynsim_edo_drag_l_T *data;
  int32_T *size;
  int32_T allocatedSize;
  int32_T numDimensions;
  boolean_T canFreeData;
...
#ifndef typedef_emxArray_f_cell_wrap_dynsim_l_T
#define typedef_emxArray_f_cell_wrap_dynsim_l_T

typedef struct emxArray_tag_pGgszObO16I6TGXaEM emxArray_f_cell_wrap_dynsim_l_T;

#endif                                 //typedef_emxArray_f_cell_wrap_dynsim_l_T

// Parameters (default storage)
typedef struct P_dynsim_edo_drag_gravity_T_ P_dynsim_edo_drag_gravity_T;

// Forward declaration for rtModel
typedef struct tag_RTM_dynsim_edo_drag_gravi_T RT_MODEL_dynsim_edo_drag_grav_T;

#endif                           // RTW_HEADER_dynsim_edo_drag_gravity_types_h_
