...
// Conversions between SL_Bus_dynsim_edo_ros_time_Time and ros::Time

void convertFromBus(ros::Time* msgPtr, SL_Bus_dynsim_edo_ros_time_Time const* busPtr)
{
...
void convertToBus(SL_Bus_dynsim_edo_ros_time_Time* busPtr, ros::Time const* msgPtr)
{
  const std::string rosMessageType("ros_time/Time");
...
// Conversions between SL_Bus_dynsim_edo_rosgraph_msgs_Clock and rosgraph_msgs::Clock

void convertFromBus(rosgraph_msgs::Clock* msgPtr, SL_Bus_dynsim_edo_rosgraph_msgs_Clock const* busPtr)
{
...
void convertToBus(SL_Bus_dynsim_edo_rosgraph_msgs_Clock* busPtr, rosgraph_msgs::Clock const* msgPtr)
{
  const std::string rosMessageType("rosgraph_msgs/Clock");
...
// Conversions between SL_Bus_dynsim_edo_sensor_msgs_JointState and sensor_msgs::JointState

void convertFromBus(sensor_msgs::JointState* msgPtr, SL_Bus_dynsim_edo_sensor_msgs_JointState const* busPtr)
{
...
void convertToBus(SL_Bus_dynsim_edo_sensor_msgs_JointState* busPtr, sensor_msgs::JointState const* msgPtr)
{
  const std::string rosMessageType("sensor_msgs/JointState");
...
// Conversions between SL_Bus_dynsim_edo_std_msgs_Float64MultiArray and std_msgs::Float64MultiArray

void convertFromBus(std_msgs::Float64MultiArray* msgPtr, SL_Bus_dynsim_edo_std_msgs_Float64MultiArray const* busPtr)
{
...
void convertToBus(SL_Bus_dynsim_edo_std_msgs_Float64MultiArray* busPtr, std_msgs::Float64MultiArray const* msgPtr)
{
  const std::string rosMessageType("std_msgs/Float64MultiArray");
...
// Conversions between SL_Bus_dynsim_edo_std_msgs_Header and std_msgs::Header

void convertFromBus(std_msgs::Header* msgPtr, SL_Bus_dynsim_edo_std_msgs_Header const* busPtr)
{
...
void convertToBus(SL_Bus_dynsim_edo_std_msgs_Header* busPtr, std_msgs::Header const* msgPtr)
{
  const std::string rosMessageType("std_msgs/Header");
...
// Conversions between SL_Bus_dynsim_edo_std_msgs_MultiArrayDimension and std_msgs::MultiArrayDimension

void convertFromBus(std_msgs::MultiArrayDimension* msgPtr, SL_Bus_dynsim_edo_std_msgs_MultiArrayDimension const* busPtr)
{
...
void convertToBus(SL_Bus_dynsim_edo_std_msgs_MultiArrayDimension* busPtr, std_msgs::MultiArrayDimension const* msgPtr)
{
  const std::string rosMessageType("std_msgs/MultiArrayDimension");
...
// Conversions between SL_Bus_dynsim_edo_std_msgs_MultiArrayLayout and std_msgs::MultiArrayLayout

void convertFromBus(std_msgs::MultiArrayLayout* msgPtr, SL_Bus_dynsim_edo_std_msgs_MultiArrayLayout const* busPtr)
{
...
void convertToBus(SL_Bus_dynsim_edo_std_msgs_MultiArrayLayout* busPtr, std_msgs::MultiArrayLayout const* msgPtr)
{
  const std::string rosMessageType("std_msgs/MultiArrayLayout");
